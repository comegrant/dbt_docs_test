...
@pytest.mark.asyncio()
async def test_training_pipelines(model_contracts: FeatureStore) -> None:
    nr_agreements = 2
...
def test_json_formatting() -> None:
    """
    Tests that we are able to format a list of product ids
    with a order of relevence into the json format that frontend expects.
    ...
    [
        {
            ...
            "week": 45,
            "productIds":[
                "5934A129-8FE1-4DCD-9402-E1AD8E820F29",
                "F45361C7-D809-4C10-8A3E-5B92F6F3EEAB",
                ...
            ]
        },
        {
