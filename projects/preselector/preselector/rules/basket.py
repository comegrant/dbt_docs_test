...
from preselector.data.models.customer import RunConfig
...
def check_dish_combination(
    ...
    combo_debug_summary["evaluating_using_preference_rules"] = str(
        run_config.should_evaluate_preference_rules,
    )
    combo_debug_summary["evaluating_using_protine_variety"] = str(
        run_config.should_evaluate_protein_variety,
    )
    ...
    # Check cost of food
    # if run_config.should_evaluate_cost_of_food:
    #         preference_variety_count, combo_debug_summary
