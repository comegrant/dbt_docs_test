...
preferences as (
	select
		...
		concept_preference_id_list as concept_preference_ids,
		taste_preferences_including_allergens_id_list as taste_preference_ids
...
final as (
	...
	left join preferences
		on active_freeze_billing_agreements.preference_combination_id
		= preferences.pk_dim_preference_combinations
	left join
	...
	where 
		product_type_id = '2F163D69-8AC1-6E0C-8793-FF0000804EB3' -- Mealbox
