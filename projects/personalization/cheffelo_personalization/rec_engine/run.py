...
from cheffelo_personalization.rec_engine.log_step import log_step
from cheffelo_personalization.rec_engine.model_registry import (
    InMemoryModelRegistry,
    ModelRegistry,
)
from cheffelo_personalization.rec_engine.ranking_model import predict_rankings
from cheffelo_personalization.rec_engine.sources import adb
from cheffelo_personalization.rec_engine.update_source import (
    update_models_from_source_if_older_than,
    update_view_from_source_if_older_than,
)
from cheffelo_personalization.source_selector import use_local_sources_in
...
async def run(
    ...
    # store = use_cache_for_model_inputs(
    #     feature_cache_location,
    #     models=[rating_model.model_contract_name, cluster_model.model_contract_name],
    #     store=store,
    # )
