...
from cheffelo_personalization.basket_preselector.data.models.utils import Yearweek
from cheffelo_personalization.basket_preselector.data.retriever import get_data_from_db
from cheffelo_personalization.basket_preselector.main import (
    run_preselector_batch_api,
    run_preselector_batch_locally,
)
from cheffelo_personalization.basket_preselector.pipeline import (
    get_company_configs,
    get_run_configs,
)
from cheffelo_personalization.basket_preselector.tests.utils import load_test_data
from cheffelo_personalization.basket_preselector.utils.storage import (
...
def run(
    ...
    config: str = "default",
    dl_tenant_id: Optional[str] = None,
    dl_client_id: Optional[str] = None,
    dl_client_secret: Optional[str] = None,
    dl_account_url: Optional[str] = None,
):
...
def main():
    args = get_args()
    print("Running preselector with input {}".format(args))
    if args.test:
        run_test()
    else:
        run(
