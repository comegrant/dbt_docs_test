...
, recipe_nutritional_facts (
    ...
    select * from {{ ref('recipe_tagging_recipe_nutritional_facts') }}
...
, recipe_allergens as (
    select
        recipes.recipe_id
        , preference_combinations.preference_name_combinations
        , preference_combinations.allergen_name_combinations
        , preference_combinations.taste_name_combinations_excluding_allergens
    from recipes
