...
, subscribed_mealboxes_unioned as (
    ...
    *
    ...
    left join dbt_snapshot_min_valid_from
        on signup_mealbox.billing_agreement_basket_id = dbt_snapshot_min_valid_from.billing_agreement_basket_id
    where signup_mealbox.valid_from < dbt_snapshot_min_valid_from.min_valid_from
