with preselector_failed_output as (
    ...
    select * from {{ source('prod__mloutputs', 'preselector_failed_realtime_output') }}
...
select
    ...
    parsed_request.compute_for as menu_year_weeks,
    parsed_request.concept_preference_ids,
    parsed_request.taste_preferences as taste_preference_ids,
    parsed_request.portion_size as portions,
    parsed_request.number_of_recipes as meals,
    parsed_request.override_deviation as is_override_deviation,
    parsed_request.ordered_weeks_ago as main_recipe_quarantining_control,
