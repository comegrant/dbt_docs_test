...
, bridge_and_dimension_joined as (
    ...
    , dim_preferences.preference_name_general
...
, preference_lists_per_type as (
    ...
    , company_id
    , preference_type_id
    , array_sort(collect_list(preference_name_general)) as preference_name_list_per_type
...
, preference_lists_all_types as (
    ...
    fk_dim_billing_agreements
    , company_id
    , array_sort(collect_list(preference_name_general)) as preference_name_list_all_types
