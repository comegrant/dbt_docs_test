...
, unique_combinations as (
    select
        preference_combination_id as pk_preference_combination_id
...
, preferences_info as (
    select
        preferences_exploded.pk_preference_combination_id
...
, preference_type_lists as (
    select
        ...
        , collect_list(preference_name_general) as preferences_name_list
        , collect_list(
            case when preference_type = 'allergen_preference' then preference_name_general end
        )                                       as allergen_preferences_name_list
        , collect_list(
            case when preference_type = 'concept_preference' then preference_name_general end
        )                                       as concept_preferences_name_list
        , collect_list(
            case when preference_type = 'taste_preference_excluding_allergens' then preference_name_general end
        )                                       as taste_preferences_excluding_allergens_name_list
        , collect_list(
            case 
                when preference_type = 'allergen_preference' 
                    or preference_type = 'taste_preference_excluding_allergens' 
                then preference_name_general 
            end
...
, add_complete_preference_list as (
    select
        unique_combinations.pk_preference_combination_id
    ...
    left join preference_type_lists
        on unique_combinations.pk_preference_combination_id = preference_type_lists.pk_preference_combination_id
)
