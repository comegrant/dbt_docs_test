...
, all_tables_joined as (
    select 
        ...
        , case when estimation_generated_at = latest_estimation_generated_at_timestamp then true else false end is_latest_estimation
        
    from estimations
    left join latest_estimation_timestamp on latest_estimation_timestamp.company_id = estimations.company_id
    left join billing_agreements on billing_agreements.billing_agreement_id = estimations.billing_agreement_id 
