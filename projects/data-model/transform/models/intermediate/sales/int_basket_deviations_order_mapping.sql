...
, deviations_find_related_order as (
    ...
    -- only include deviations that has an order
...
, deviations_add_aggregated_columns as (
    ...
    select
        ...
        -- get the timestamp of the lastest deviation created by the preselector or mealselector
        , max(
            case 
...
-- find the timestap to be used when relating orders to billing agreements
