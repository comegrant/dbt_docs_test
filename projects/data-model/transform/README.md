...
The 'transform' project was generated by using the dbt template for
...
3. Install dbt
   ...
   Run these instructions from the `transform` directory. We recommend making
...
`[dev yourname] transform_job` to your workspace.
...
When deploying to this target, note that the default job at resources/transform_job.yml
