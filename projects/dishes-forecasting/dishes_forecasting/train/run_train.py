...
def run_train(args: Args) -> tuple[Pipeline, pd.Series, pd.Series, pd.Series, pd.Series]:
    ...
    custom_pipeline, X_train, X_test, y_train, y_test, mape, mae, df_test_metrics, df_test_binned = train_model(  # noqa
