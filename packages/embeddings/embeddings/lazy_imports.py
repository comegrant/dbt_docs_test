...
class _LazyModule(ModuleType):
    ...
    def __getattr__(self, name: str) -> Any:  # noqa
...
if TYPE_CHECKING:
    ...
    sentence_transformers, _POLARS_AVAILABLE = _lazy_import("sentence_transformers")
    torch, _PYTORCH_AVAILABLE = _lazy_import("torch")
