...
class RedisOnlineStore:
    ...
    def _load_environment_vars(self, params: dict) -> None:
        """
    ...
    def delete_keys(self, prefix: str) -> None:
        """
