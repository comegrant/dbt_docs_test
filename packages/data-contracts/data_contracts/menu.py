...
@feature_view(
    name="year_week_menu_with_portions",
...
@feature_view(
    ...
    source=adb.fetch(year_week_menu_sql).with_loaded_at(),
    materialized_source=materialized_data.parquet_at("year_week_menu.parquet"),
)
class YearWeekMenu:
